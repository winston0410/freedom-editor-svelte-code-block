...
/* src/components/CodeBlock.svelte generated by Svelte v3.24.0 */

function create_fragment(ctx) {
	let pre;
	let code;
	let t_value = helper.getSavedData(/*savedData*/ ctx[0]) + "";
	let t;
	...
	return {
		...
		p(ctx, [dirty]) {
			if (dirty & /*savedData*/ 1 && t_value !== (t_value = helper.getSavedData(/*savedData*/ ctx[0]) + "")) set_data(t, t_value);
		},
		i: noop,
		o: noop,
		d(detaching) {
...
function instance($$self, $$props, $$invalidate) {
	let { i18n } = $$props, { savedData } = $$props;

	$$self.$set = $$props => {
		if ("i18n" in $$props) $$invalidate(1, i18n = $$props.i18n);
		if ("savedData" in $$props) $$invalidate(0, savedData = $$props.savedData);
	};

	return [savedData, i18n];
}

class CodeBlock extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { i18n: 1, savedData: 0 });
	}
}

var CodeBlock$1 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    'default': CodeBlock
});
...
var CodeBlock$2 = getCjsExportFromNamespace(CodeBlock$1);
...
class Code {
  ...
  render (i18n, savedData) {
    ...
    const codeBlock = new CodeBlock$2({
